# Symmetry-Aware Rao-Blackwell Estimator #
...
# print the KL divergence every 10000 samples
...
# iterate over the orbits of the variables
for o in orbs do

# compute average value of the marginals
orbSum := 0.0;;
for i in o do
orbSum := orbSum + tmpMargs[i];;
od;;

norm := Float(Length(o));;

for i in o do
tmpMargs[i] := orbSum / norm;;
od;;
od;;

kl := kullback(tmpMargs, correctMargs, 3, numOfNonEvidenceVariables);;
#Print((runtimeSum()-sampleTimer)/1000.0+buildHashTime, sampleCounter, "\n");;
...
#PrintTo("grid_soft_marginals.g", "correctMargs := ");;
#AppendTo("grid_soft_marginals.g", tmpMargs);;
#AppendTo("grid_soft_marginals.g", ";;");;
